...
export const addMedicineData = async (formData) => {
  try {
    const response = await axios.post(
      `${process.env.React_App_Base_url + "add-medicine"}`,
      formData
    );
    return response;
  } catch (error) {
...
export const updateOneMedicineData = async (Id, formData) => {
  try {
    const response = await axios.put(
      `${process.env.React_App_Base_url + "update-one-medicine-data/" + Id}`,
      formData
    );
    return response;
  } catch (error) {
...
export const addDiagonsisData = async (formData) => {
  try {
    const response = await axios.post(
      `${process.env.React_App_Base_url + "Add-Test"}`,
      formData
    );
    return response;
  } catch (error) {
...
export const updateOneDiagonsisData = async (Id, formData) => {
  try {
    const response = await axios.put(
      `${process.env.React_App_Base_url + "update-one-test-data/" + Id}`,
      formData
    );
    return response;
  } catch (error) {
...
export const addAdmissionChargeData = async (formData) => {
  try {
    const response = await axios.post(
      `${process.env.React_App_Base_url + "add-admission-charge"}`,
      formData
    );
    return response;
  } catch (error) {
...
export const updateAdmissionChargeData = async (Id, formData) => {
  try {
    const response = await axios.put(
      `${process.env.React_App_Base_url + "update-one-admission-charge/" + Id}`,
      formData
    );
    return response;
  } catch (error) {
...
export const addVitalServiceData = async (formData) => {
  try {
    const response = await axios.post(
      `${process.env.React_App_Base_url + "add-vital-care"}`,
      formData
    );
    return response;
  } catch (error) {
...
export const updateVitalServiceData = async (Id, formData) => {
  try {
    const response = await axios.put(
      `${process.env.React_App_Base_url + "update-one-vital-care/" + Id}`,
      formData
    );
    return response;
  } catch (error) {
...
export const getAllHospitalInventoryData = async () => {
  try {
    const response = await axios.get(
      `${process.env.React_App_Base_url + "get-all-hospital-inventry"}`
    );
    return response;
  } catch (error) {
    console.log(error);
...
export const addHospitalInventoryData = async (formData) => {
  try {
    const response = await axios.post(
      `${process.env.React_App_Base_url + "add-hospital-inventry"}`,
      formData
    );
    return response;
  } catch (error) {
...
export const getHospitalInventoryData = async (Id) => {
  try {
    const response = await axios.get(
      `${process.env.React_App_Base_url + "get-one-Hospital-Inventry/" + Id}`
    );
    return response;
  } catch (error) {
    console.log(error);
...
export const updateHospitalInventoryData = async (Id, formData) => {
  try {
    const response = await axios.put(
      `${
        process.env.React_App_Base_url + "update-one-Hospital-Inventry/" + Id
      }`,
      formData
    );
    return response;
...
export const deleteHospitalInventoryData = async (Id) => {
  try {
    const response = await axios.delete(
      `${process.env.React_App_Base_url + "delete-one-hospital-Inventry/" + Id}`
    );
    return response;
  } catch (error) {
    console.log(error);
