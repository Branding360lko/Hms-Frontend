...
const SuperAdminEmergencyPatientPage = lazy(() =>
...
const SuperAdminIPDPatientRecieptDownloadPage = lazy(() =>
  import(
    "./components/superadmin/IPD_PatientTable/IPD_PatientReciept/IPD_PatientReciept"
  )
);
...
// Doctor
const DoctorPanelDashboard = lazy(() => import("./pages/Doctors/Dashboard"));

const DoctorPanelPatientPrescription = lazy(() =>
  import("./pages/Doctors/PatientPrescription/PatientPrescription")
);
            ...
            <Routes>
                  ...
                  <Route
                    ...
                    element={
                      <Suspense
                        ...
                        <SuperAdminEmergencyPatientPage />
                      </Suspense>
                    }
                  />
                  <Route
              ...
              {adminRole === "Doctor" ? (
                <Route path={browserLinks.doctor.category}>
                  <Route
                    path={browserLinks.doctor.internalPages.dashboard}
                    element={
                      <Suspense
                        fallback={
                          <>
                  ...
                  <Route
                    ...
                    }/${browserLinks?.doctor?.internalPages?.patientPrescription
                      ?.split(" ")
                      .join("")}`}
                    element={
                      <Suspense
                        ...
                        <DoctorPanelPatientPrescription />
                      </Suspense>
                    }
                  />
                </Route>
