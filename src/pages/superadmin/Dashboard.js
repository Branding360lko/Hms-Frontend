...
const NewPatientDashboardTable = lazy(() =>
  import(
    ...
    <div className="superadmin-main flex flex-row w-full h-screen">
      ...
      <div className="superadmin-main-right flex flex-col w-[80%]">
        ...
        <div className="superadmin-main-right_dashboard flex flex-col w-full p-[1rem] overflow-y-scroll gap-[2rem]">
          ...
          <NewPatientDashboardTable data={dashBoardCardData?.PatientData} />
          <NewOPDPatientsDashboardTable
            data={dashBoardCardData?.OPDPatientData}
          />
          <NewIPDPatientsDashboardTable
            data={dashBoardCardData?.IPDPatientData}
          />
